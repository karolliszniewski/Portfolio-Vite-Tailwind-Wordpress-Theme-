...
<section id="hero" class="h-full-without-header-mobile md:h-full-without-header-desktop relative overflow-hidden flex items-center justify-center w-[100%] ">
  ...
  <div class="h-[100%] max-w-screen-xl mx-10 w-[100%]  grid grid-cols-1 md:grid-cols-2">
    <div class="h-full w-full flex flex-col">
      ...
      <div class="m-auto ">
        <h1 class="text-6xl 2xl:text-7xl font-bold text-white hero__reveal">
          Hi, I'm Karol!<br />
          Freelance <span class="text-yellow-theme">developer</span>
        </h1>
        <span class="text-[#CCCCCC] relative top-3 hero__reveal">I build and maintain websites in WordPress, PHP and JavaScript. Custom themes and ACF builds, WooCommerce, and inherited codebases that need untangling. Based in Stoke-on-Trent, working with businesses and agencies across the UK.</span>
        <div class="h-[20rem] w-full flex justify-center items-center">
          <div class="h-full w-full relative flex items-center justify-center">
            <a href="https://creativevault.ovh/KarolLiszniewski-figmaCV.pdf" class="bg-yellow-theme h-[4rem] w-[12rem] items-center flex justify-center relative hero__reveal">Download CV
            ...
            <div class="w-[50%]">
              <div class="flex w-full h-16 justify-evenly hero__reveal">
                <a href="https://github.com/karolliszniewski" target="_blank" class="flex flex-col items-center justify-center group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="30px" height="30px" fill="#FFDD95">
                ...
                <a href="https://www.youtube.com/channel/UClBicmLd-3GhmonZIHtcmjw" target="_blank" class="flex flex-col items-center justify-center group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="30px" height="30px" fill="#FFDD95">
                    <path d="M 44.898438 14.5 C 44.5 12.300781 42.601563 10.699219 40.398438 10.199219 C 37.101563 9.5 31 9 24.398438 9 C 17.800781 9 11.601563 9.5 8.300781 10.199219 C 6.101563 10.699219 4.199219 12.199219 3.800781 14.5 C 3.398438 17 3 20.5 3 25 C 3 29.5 3.398438 33 3.898438 35.5 C 4.300781 37.699219 6.199219 39.300781 8.398438 39.800781 C 11.898438 40.5 17.898438 41 24.5 41 C 31.101563 41 37.101563 40.5 40.601563 39.800781 C 42.800781 39.300781 44.699219 37.800781 45.101563 35.5 C 45.5 33 46 29.398438 46.101563 25 C 45.898438 20.5 45.398438 17 44.898438 14.5 Z M 19 32 L 19 18 L 31.199219 25 Z" />
                  </svg>
                </a>

                <a href="https://www.linkedin.com/in/karolliszniewski/" target="_blank" class="flex flex-col items-center justify-center group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="30px" height="30px" fill="#FFDD95">
    ...
    <div class="h-full w-full  items-center justify-center hidden md:flex">
      <img src="<?= PORTFOLIOKAROL_DIR_URI ?>/assets/img/karolLiszniewski-photo.webp" alt="karol liszniewski photo" srcset="" class="hero__reveal md:translate-x-10" />
    </div>
  </div>
</section>
