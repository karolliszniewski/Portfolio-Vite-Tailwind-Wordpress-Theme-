...
if(!defined('PORTFOLIOKAROL_DIR_PATH')){ define('PORTFOLIOKAROL_DIR_PATH', untrailingslashit(get_template_directory()));}
if(!defined('PORTFOLIOKAROL_DIR_URI')){ define('PORTFOLIOKAROL_DIR_URI', untrailingslashit(get_template_directory_uri()));}
